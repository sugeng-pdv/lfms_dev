...
{
    $.ajax({
            url     : backend_url+'Spp-approved/data-spp',
            type    : 'POST',
            data    : {'id_spp':''},
            dataType: 'JSON',
            cache   : false,
            ...
            { 
                ...
                if(resp.status === 'success'){
                    $.each(dataColums, function( index, value ) {
                        var statusSpp;
                        var sppClass,infoSpp,sppClass;
                        if(value.status_spp === 'Terbayar'){
                            statusSpp = false;
                            sppClass = 'label label-lg label-light-success label-inline';
                            infoSpp = 'Sudah terbayar ke PPK tanggal '+value.date_received;
                            btnClass = 'btn btn-outline-success font-weight-bold btn-lg btnDetailSpp';
                        }else{
                            statusSpp = true;
                            sppClass='label label-lg label-light-warning label-inline';
                            infoSpp='Menunggu Pembayaran SPP';
                            btnClass = 'btn btn-success font-weight-bold btn-lg btnDetailSpp';
                        }
                        ...
                        $('#spp-'+value.id+' #status_spp').text(infoSpp).attr('class',sppClass);
                        $('#spp-'+value.id+' #btnDetailSpp').attr('onclick','paymentConfirm("'+value.id+'")').attr('class',btnClass);
                        $('#spp-'+value.id).show();
           			});
