                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="pl-0" colspan="2">
                                            <a href="#" class="text-dark-75 font-weight-bolder text-hover-primary mb-1 font-size-lg">Info</a>
                                            <div>
                                                <span class="text-muted font-weight-bold text-hover-primary" id="psn_info"></span>
                                                <!--<a class="text-muted font-weight-bold text-hover-primary" href="#"></a>-->
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <!--</td>-->
                                        <td class="pr-0 text-right">
                                            <button class="btn btn-success font-weight-bold btn-lg btnCompleteField" id="btnCompleteField">
