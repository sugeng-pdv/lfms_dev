    ...
    <!--<div class="d-flex flex-row flex-column-fluid page">-->
		...
		<div class="container-lg">
			<div class="card-body p-0">
				...
				<div class="row bg-success-o-20 mt-3">
					<div class="col">
						<ul class="nav nav-tabs nav-tabs-line" role="tablist">
							<li class="nav-item">
								<a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#nav-id" data-url="2">
									<span class="nav-icon">
							...
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-2" data-toggle="tab" href="#nav-bk" data-url="2" aria-controls="profile">
									<span class="nav-icon">
							...
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-3" data-toggle="tab" href="#nav-lhp" data-url="3" aria-controls="contact">
									<span class="nav-icon">
							...
							<!--talangan-->
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-4" data-toggle="tab" href="#nav-receipt" data-url="3" aria-controls="contact">
									<span class="nav-icon">
							...
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-5" data-toggle="tab" href="#nav-baugr" data-url="3" aria-controls="contact">
									<span class="nav-icon">
							...
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-6" data-toggle="tab" href="#nav-baph" data-url="3" aria-controls="contact">
									<span class="nav-icon">
										<i class="flaticon-folder text-warning"></i>
									</span>
							...
							<!--langsung pengadilan-->
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-7" data-toggle="tab" href="#nav-bpn" data-url="4" aria-controls="contact">
									<span class="nav-icon">
							...
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-8" data-toggle="tab" href="#nav-pp" data-url="4" aria-controls="contact">
									<span class="nav-icon">
							...
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-8" data-toggle="tab" href="#nav-bapp" data-url="4" aria-controls="contact">
									<span class="nav-icon">
										<i class="flaticon-home-2 text-warning"></i>
									</span>
							...
							<!--spp-->
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-9" data-toggle="tab" href="#nav-bpn" data-url="4" aria-controls="contact">
									<span class="nav-icon">
										<i class="flaticon-folder-1 text-warning"></i>
									</span>
							...
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-10" data-toggle="tab" href="#nav-sptjm" data-url="5" aria-controls="contact">
									<span class="nav-icon">
										<i class="flaticon-folder text-warning"></i>
									</span>
							...
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-11" data-toggle="tab" href="#nav-skd" data-url="6" aria-controls="contact">
									<span class="nav-icon">
										<i class="flaticon-folder-1 text-warning"></i>
									</span>
									<span class="nav-text font-weight-bolder">Kesesuaian Dokumen</span>
								</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" id="nav-tab-12" data-toggle="tab" href="#nav-add-doc" data-url="7" aria-controls="contact">
									<span class="nav-icon">
										<i class="flaticon-folder-1 text-warning"></i>
									</span>
						...
						<div class="col-xl-8 col-xxl-8 mt-5">
							<div style="width:auto; height:auto;">
								<div class="tab-pane fade show active" id="nav-id" role="tabpanel" aria-labelledby="nav-tab-1">
									<embed src="" frameborder="0" width="50%" height="60px" id="embed_view_id">
								...
								<div class="tab-pane fade" id="nav-bk" role="tabpanel" aria-labelledby="nav-tab-2">
									<embed src="" frameborder="0" width="50%" height="10px" id="embed_view_bk">
								</div>
								<div class="tab-pane fade" id="nav-lhp" role="tabpanel" aria-labelledby="cnav-tab-3">
									<embed src="" frameborder="0" width="50%" height="900px" id="embed_view_lhp">
								</div>
								<div class="tab-pane fade" id="nav-bpn" role="tabpanel" aria-labelledby="nav-tab-4">
									<embed src="" frameborder="0" width="50%" height="900px" id="embed_view_bpn">
								</div>
								<div class="tab-pane fade" id="nav-sptjm" role="tabpanel" aria-labelledby="nav-tab-5">
									<embed src="" frameborder="0" width="50%" height="900px" id="embed_view_sptjm">
								</div>
							</div>
						</div>
