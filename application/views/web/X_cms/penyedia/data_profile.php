										...
										<form id="form_id_perusahaan">
											<div class="row">
												...
												<div class="col-md-6">
													...
													<div class="form-group">
														<h5>No. Whatapps Perusahaan <span class="text-danger">*</span></h5>
														<div class="controls">
															<input type="text" name="no_wa_perusahaan" class="form-control" required data-validation-containsnumber-regex="(\d)+" data-validation-containsnumber-message="No Characters Allowed, Only Numbers">
														</div>
														<!-- <div class="form-control-feedback"><small>Add <code>*</code> attribute to field for required validation.</small></div> -->
													</div>
													<div class="form-group">
							...
							<div class="modal-body">
								<div class="row">
									<div class="col-md-6">
										...
										<div class="form-group row">
											<label class="col-form-label col-md-4">Telepon Penerbit</label>
											<div class="col-md-8">
												<input class="form-control" type="number" name="tlp_penerbit">
												<!-- <span class="form-text text-muted"><code>*</code></span> -->
											</div>
										</div>
									</div>
						...
						<form id="form_add_pemilik_usaha">
							<div class="modal-body">
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input class="form-control" type="text" name="npwp_pemilik_usaha" required>
										<span class="form-text text-muted"><code>*</code></span>
									</div>
								</div>
								<div class="form-group row">
					...
					<div class="modal-content">
						...
						<form id="form_add_pajak_usaha">
							<div class="modal-body">
								...
								<div class="form-group row">
									<label class="col-form-label col-md-4">keterangan Pajak</label>
									<div class="col-md-8">
										<select class="form-control select2" name="status_pajak" style="width: 100%;" required>
						...
						<form id="form_add_fotokantor_usaha">
							<div class="modal-body">
								<div class="form-group row">
									...
									<div class="col-md-8">
										<input class="form-control" type="text" name="proses_jns_fotokantor_usaha" required>
										<input class="form-control" type="text" name="id_token_fotokantor">
								...
								<div class="form-group row">
									...
									<div class="col-md-8">
										...
										<!-- <input class="form-control" type="file" id="file" ref="file" v-on:change="handleFileChange()" required/> -->
										<input class="form-control" type="file" id="file_upload" ref="file" required/>
								...
								<div class="form-group row">
									...
									<div class="col-md-12">
										<center>
											...
											<!-- <img :src="this.state.tempImageUrl" class="img-fluid"> -->
										</center>
									</div>
								</div>
							</div>
							...
							<div class="modal-footer modal-footer-uniform float-right">
								<button v-on:click="uploadFile();" class="btn btn-bold btn-pure btn-primary float-right">Simpan</button>
							</div>
						</form>
