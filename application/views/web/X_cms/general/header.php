...
<head>
  <meta charset="utf-8">
	...
	<link rel="icon" href="<?php echo $this->config->item('static_file_url').PLATFORM_PATH; ?>img/logo/lman-logo-52.png">

    <title><?php echo $title; ?></title>
  
	<!-- Bootstrap 4.0-->
	<link rel="stylesheet" type="text/css" href="<?php echo $this->config->item('static_file_url').PLATFORM_PATH; ?>cms/vendor_components/bootstrap/dist/css/bootstrap.min.css">
	...
	<!-- Bootstrap select -->
	<link rel="stylesheet" href="<?php echo $this->config->item('static_file_url').PLATFORM_PATH; ?>cms/vendor_components/bootstrap-select/dist/css/bootstrap-select.css">
	<!-- Select2 -->
	<link rel="stylesheet" type="text/css"  href="<?php echo $this->config->item('static_file_url').PLATFORM_PATH; ?>cms/vendor_components/select2/dist/css/select2.min.css">

	<?php if( isset($css) ){ foreach ($css as $css){ ?>
        <link  rel="stylesheet" type="text/css" href="<?php echo $this->config->item('static_file_url').PLATFORM_PATH.$css; ?>">
    <?php }} ?>
    ...
    <!-- Brana - load vue.js dan axios -->
    <script src="https://cdn.jsdelivr.net/npm/vue/dist/vue.js" type="text/javascript"></script>
    <script src="https://unpkg.com/axios/dist/axios.min.js" type="text/javascript"></script>
	
</head>
<body class="hold-transition skin-lman dark-sidebar sidebar-collapse sidebar-mini fixed">
<!-- <body class="hold-transition skin-lman dark-sidebar sidebar-mini fixed"> -->
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      <!-- mini logo -->
	  <div class="logo-mini">
		  <span class="light-logo"><img src="<?php echo $this->config->item('static_file_url').PLATFORM_PATH; ?>img/logo/lman-logo-52.png" alt="logo"></span>
      ...
      <div class="logo-lg">
		  <!-- <span class="light-logo"><img src="<?php echo $this->config->item('static_file_url').PLATFORM_PATH; ?>cms/images/logo-light-text.png" alt="logo"></span> -->
	  	  <span class="dark-logo"><img src="<?php echo $this->config->item('static_file_url').PLATFORM_PATH; ?>img/logo/lman-logo-52.png" alt="logo"></span>
	  </div>
    </a>
    <!-- Header Navbar -->
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              <!-- User image -->
              <li class="user-header bg-img" style="background-image: url(<?php echo $this->config->item('static_file_url').PLATFORM_PATH; ?>cms/images/user-info.jpg)" data-overlay="3">
