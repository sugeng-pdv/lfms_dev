...
class Monitoring_payment extends CI_Controller {
	...
	public function index()
	{
	    ...
	    $data['js'] = array(
			'assets/js/lfm/ppk/monitoring_payment.js',
			);
		...
		$data = array(
				...
				'content'	    => $this->load->view(PLATFORM_PATH.'ppk/monitoring_payment',$data,true),
				'js'            =>array(
				    'assets/js/lfm/ppk/monitoring_payment.js',
				    )
				);
	...
	public function data_allocations()
	{
	    $postdata=$_POST;
        $result = $this->lman_library->senddataurl('Monitoring/spp_allocations_ppk',$postdata,'POST');
        echo json_encode($result);
	}
