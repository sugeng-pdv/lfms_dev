...
class Penelitian_administrasi_ppk_bidang extends CI_Controller {
	...
	public function index()
	{
	   // $result = $this->senddataurl('Auth/',$postdata,'POST');
	    ...
	    $data['js'] = array(
			'assets/js/lfm/staff/penelitian_administrasi_ppk_bidang.js',
			);
    // 		$this->load->view(PLATFORM_PATH.'auth/index',$data);
		...
		$data = array(
				...
				'content'	    => $this->load->view(PLATFORM_PATH.'staff/penelitian_administrasi_ppk_bidang',$data,true),
				'js'            =>array(
