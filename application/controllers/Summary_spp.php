...
class Summary_spp extends CI_Controller {
	...
	public function index()
	{
	   // $result = $this->senddataurl('Auth/',$postdata,'POST');
	    $data['title']      = "Summary Penelitian SPP- Land Funding Management Lembaga Manajemen Aset Negara";
	    $data['menu_text']= "Summary Penelitian SPP";
	    $data['content_header']= "Land Funding Manajemen Lembaga Manajemen Aset Negara - Summary Penelitian SPP";
	    $data['js'] = array(
			'assets/js/lfm/kadiv/summary_spp.js',
			);
    // 		$this->load->view(PLATFORM_PATH.'auth/index',$data);
		
		$data = array(
		        'status'=>true,
				'title'	=> "Summary Penelitian SPP - Land Funding Management Lembaga Manajemen Aset Negara",
				'menu_text'		=> "Summary Penelitian SPP",
				'content_header' => "Land Funding Manajemen Lembaga Manajemen Aset Negara - Summary Penelitian SPP",
				'content'	    => $this->load->view(PLATFORM_PATH.'kadiv/summary_spp',$data,true),
				'js'            =>array(
